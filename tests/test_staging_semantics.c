...
int main(void){test_ah();test_airplay();test_cast();test_dlna();test_dnp3();test_esp();test_ftp();test_ike();test_knx();test_ldap();test_ldaps();test_matter();test_mongodb();test_nvmeof();test_opcua();test_openvpn();test_redis();test_rtcp();test_rtp();test_rtsp();test_s7();test_tacacs();test_thread();test_vnc();test_winrm();return 0;}
