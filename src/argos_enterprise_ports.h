...
static const uint16_t ARGOS_ENTERPRISE_TCP_PORTS[] = {
    22, 88, 111, 179, 445, 502, 514, 515, 631, 1433, 1521, 1883, 2000,
    2049, 3260, 3306, 3389, 4739, 5060, 5432, 9100, 44818
};
static const uint16_t ARGOS_ENTERPRISE_UDP_PORTS[] = {
    88, 111, 123, 161, 162, 389, 427, 514, 623, 1812, 1813, 1985,
    2049, 2055, 3478, 4739, 5060, 5678, 5683, 6343, 9995, 9996,
    47808, 44818
};
