...
#define ARGOS_PROTOCOL_CATALOG(X) \
    ...
    X(HTTP_PROXY, APPLICATION, "http-proxy", ARGOS_PROTOCOL_STATUS_PRODUCTION) \
    X(RDP, APPLICATION, "rdp", ARGOS_PROTOCOL_STATUS_PRODUCTION) \
    X(SSH, APPLICATION, "ssh", ARGOS_PROTOCOL_STATUS_PRODUCTION) \
    X(TELNET, APPLICATION, "telnet", ARGOS_PROTOCOL_STATUS_PRODUCTION) \
    X(VNC, APPLICATION, "vnc", ARGOS_PROTOCOL_STATUS_PRODUCTION) \
    X(WINRM, APPLICATION, "winrm", ARGOS_PROTOCOL_STATUS_PRODUCTION) \
    ...
    X(LPD, APPLICATION, "lpd", ARGOS_PROTOCOL_STATUS_PRODUCTION) \
